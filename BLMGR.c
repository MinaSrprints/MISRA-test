...
static u8 CheckCrc(void)
{
    ...
    SECR_GnerateCrc(TempBuffer_10,BLMGR_TxDeviceNameLength + 2u, &GenCrc_1,BLMGR_CrcKey);
    if(GenCrc_1 == RxCrc)
    {
        BLMGR_ErrorState = ERRH_NO_ERROR;
        IsFrameValid_4 = 1u;
...
static u8 GetCrcKey(void)
{
    ...
    {
        SECR_GnerateCrc(TempBuffer_7,BLMGR_TxDeviceNameLength + 2u, &GenCrc_3,(LoopIndex_6 | 0x10000u));
        if(GenCrc_3 == RxCrc_1)
        {
